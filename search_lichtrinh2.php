            ...
            <div class="container" style="text-align: center;justify-content: center;">
                ...
                <div class="card card-raised card-form-horizontal no-transition">
                    <div class="card-block">
                        <form action="search_lichtrinh2.php" method="post">
                            <div class="row">
                ...
                <h3 style="font-weight:bold;">Kết quả tìm kiếm lịch trình</h3><br><br>
                <?php
                $sql = "SELECT * FROM `lichtrinh` WHERE name LIKE '%$name%' AND deadline LIKE '%$deadline%' AND status LIKE '%$status%' ORDER BY id DESC";
                ...
                <div class="row" style="background-color:#fafafa;border-radius:10px;padding:20px;margin-bottom:15px;">
                    ...
                    <div class="col-md-4" style="margin-top:auto; margin-bottom:auto; margin-left:0px;">
                            <a href=' . 'lichtrinh_detail2.php?id=' . $row['id'] . ' class="btn btn-info btn-round" style="margin-bottom:5px; color: white;margin-right:10px;"> Xem lịch trình</a>
                    </div>
