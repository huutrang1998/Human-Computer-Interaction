                    ...
                    <div class="card card-contact no-transition">
                        <div class="row" style="padding:50px;">
                            <div class="col-md-8 offset-md-2">
                                <div>
                                    <form method="POST" enctype="multipart/form-data" action="update_lichtrinh.php?id=<?php echo $row['id']?>">

                                        <div class="card-block">
                                           

                                            <div class="form-group label-floating">
                                                <label class="control-label">Nhân viên phụ trách mới:(*)</label>
                                                <input id="name" type="name" name="name" class="form-control" value="<?php echo $row['name']?>" required>
                                            </div>
                                            <div class="form-group label-floating">
                                                <label class="control-label">Thay đổi hạn hoàn thành:(*)</label>
                                                <input id="status" name="status" type="date" class="form-control" value="<?php echo $row['deadline']?>"  required>
                                            </div>
                                            <div class="form-group label-floating">
                                                <label class="control-label">Ghi chú mới (*): </label>
                                                <input id="description" type="text" name="description" value="<?php echo $row['note']?>"  class="form-control"></input>
                                            </div>
            ...
            <?php
                ...
                <div class="row" style="background-color:#fafafa;border-radius:10px;padding:20px;">
                        ...
                        <div class="col-md-5" style="margin-top:auto; margin-bottom:auto">
                            ...
                            <br><br> 
                            <a href="danh_sach_lich_trinh.php" class="btn btn-info btn-round" name="" type="" style=" color: white;margin-right:20px;"> Quay lại</a>
