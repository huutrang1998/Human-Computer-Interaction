                    ...
                    <div class="card card-contact no-transition">
                        <div class="row" style="padding:50px;">
                            <div class="col-md-8 offset-md-2">
                                <div>
                                    <form method="POST" enctype="multipart/form-data" action="update_lichtrinh2.php?id=<?php echo $row['id']?>">
                                        ...
                                        <div class="card-block">
                                            ...
                                            <div class="form-group label-floating">
                                                ...
                                                <select id="name" type="name" name="name" class="form-control" value="<?php echo $row['name']?>" required>
                                                <option value="Chưa hoàn thành">Chưa hoàn thành</option>
                                                <option value="Đang kiểm tra">Đang kiểm tra</option>
                                                <option value="Đang tiến hành sửa chữa">Đang tiến hành sửa chữa</option>
                                                <option value="Hoàn thành kiểm tra và trạm đã hoạt động bình thường">Hoàn thành kiểm tra và trạm đã hoạt động bình thường</option>
            ...
            <?php
                ...
                <div class="row" style="background-color:#fafafa;border-radius:10px;padding:20px;">
                        ...
                        <div class="col-md-5" style="margin-top:auto; margin-bottom:auto">
                            <p><strong>Mã đợt kiểm tra :  ' . ($row['id']) . '</strong></p>
                            <p>Nhân viên phụ trách :  ' . ($row['name']) . '</p>
                            <p> Hạn hoàn thành : ' . ($row['deadline']) .'</p>
                            <p> Ghi chú : ' . ($row['note']) . '</p>
                           
                            <p> Thông tin chi tiết : ' . ($row['plan']) . '</p>
                            <p> Tiến độ : ' . ($row['status']) . '</p>
                            <br><br> 
                            <a href="cong_viec.php" class="btn btn-info btn-round" name="" type="" style=" color: white;margin-right:20px;"> Quay lại</a>
                            ';
                           if($row['name']==$_SESSION['fullname']){
                             echo  '<a class="btn btn-danger btn-round" onclick="openNav()" type="" style=" color: white;">  Cập nhật tiến độ công việc </a>';
                           } 
                   echo '</div>
                    </div>
                    ';
