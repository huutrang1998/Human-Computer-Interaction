...
<div id="navbar-zone">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbars-seo">
                        ...
                        <a class="nav-link" href="logout.php" data-scroll="true">Đăng xuất</a>
                                ...
                                echo '
						<li class="nav-item active"><a class="nav-link" href="register.php">Đăng Ký</a></li>
     ...
     <div class="contact_form" style="text-align:center;padding:70px;">
                        ...
                        <div id="message"><h1> Nhập đầy đủ thông tin để đăng ký </h1><br><br></div>
                        <form action="register_submit.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="username" id="username" class="form-control" placeholder="Set user name" required>
                                </div>   
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                <input type="age" name="age" id="age" class="form-control" placeholder="Your Age" required>
                                </div>
                                <div class="col-md-12">
                                    <button type="submit" value="acp" id="acp" name="acp" class="bttn-new-a">Xác nhận đăng ký</button>
                                </div>
                            </div>
                        </form>
                    </div>
